...
# TRANSFORMER related params
config.TRANSFORMER = edict()
config.TRANSFORMER.N_EMBD = []
config.TRANSFORMER.N_HEAD = 4
config.TRANSFORMER.ATTN_PDROP = 0.0
config.TRANSFORMER.PROJ_PDROP = 0.0
config.TRANSFORMER.PATH_PDROP = 0.0
config.TRANSFORMER.MHA_WIN_SIZE = 19
config.TRANSFORMER.MAX_SEQ_LEN = 2304
config.TRANSFORMER.MAX_BUFFER_LEN_FACTOR = 6.0

# LOSS related params
config.LOSS = edict()
config.LOSS.LOSS_NORMALIZER_MOMENTUM = 0.9
config.LOSS.LOSS_NORMALIZER = 2000
config.LOSS.TRAIN_LABEL_SMOOTHING = 0.0
config.LOSS.TRAIN_LOSS_WEIGHT = 1.0
# config.LOSS.
# config.LOSS.
